...
describe("15.02 SEC-05 — WeakSet.prototype.has cannot validate a raw grant target", () => {
   it("rejects a raw target when membership is replaced during config loading", () => {
